...
Resource.prototype.find = function(key, includeMetaData) {
  return this.repository.find(this.name, key, includeMetaData);
};

Resource.prototype.findAll = function(query, includeMetaData) {
  return this.repository.findAll(this.name, query, includeMetaData);
};
